...
import { getAllTaskPriorities, setCreateModal, setDefaultPriorityModal, setEditModal, setViewModal } from '@/store/Slices/taskSlice/taskPrioritySlice';
import { setDeleteModal } from '@/store/Slices/taskSlice/taskPrioritySlice';
