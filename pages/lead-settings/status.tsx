...
import { getAllLeadStatus, setCreateModal, setDefaultStatusModal, setDeleteModal, setEditModal, setLeadStatusDataLength, setPage, setPageSize, setViewModal } from '@/store/Slices/leadSlice/leadStatusSlice';
...
const LeadStatusPage = () => {
    ...
    const { data, isFetching, isAbleToChangeDefaultStatus, isAbleToCreate, isAbleToDelete, isAbleToRead, isAbleToUpdate, totalRecords, pageSize, page } = useSelector(
        (state: IRootState) => state.leadStatus
    );
