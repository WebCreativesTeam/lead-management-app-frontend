...
import { BranchDataType, GetMethodResponseType, SelectOptionsType } from '@/utils/Types';
...
const BranchPage = () => {
    ...
    //hooks
    const data: BranchDataType[] = useSelector((state: IRootState) => state.branch.data);
    const isFetching: boolean = useSelector((state: IRootState) => state.branch.isFetching);
    const isBtnDisabled: boolean = useSelector((state: IRootState) => state.branch.isBtnDisabled);
    const deleteModal: boolean = useSelector((state: IRootState) => state.branch.deleteModal);
    ...
    const onDeleteBranch = async () => {
        ...
        const deleteBranch: BranchDataType = await new ApiClient().delete('branches/' + singleBranch.id);
