...
const ContactViewModal = () => {
    ...
    const reqData: any = {
        ...
        phoneNumber,
        company,
        industry: industry ? industry : <div className="text-danger">Not Provided</div>,
        position: position ? position : <div className="text-danger">Not Provided</div>,
        ['Wedding Anniversary']: anniversary ? new Date(anniversary).toLocaleDateString() : <div className="text-danger">Not Provided</div>,
        ['Date Of Birth']: DOB ? new Date(DOB).toLocaleDateString() : <div className="text-danger">Not Provided</div>,
        ...
        twitterProfile: twitterProfile ? twitterProfile : <div className="text-danger">Not Provided</div>,
        facebookProfile: facebookProfile ? facebookProfile : <div className="text-danger">Not Provided</div>,
        website: website ? website : <div className="text-danger">Not Provided</div>,
