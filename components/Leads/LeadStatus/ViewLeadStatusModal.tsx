...
import { setViewModal } from '@/store/Slices/leadSlice/leadStatusSlice';
import { IRootState } from '@/store';

const LeadStatusViewModal = () => {
    const { viewModal, singleData } = useSelector((state: IRootState) => state.leadStatus);
    const dispatch = useDispatch();

    return (
        <ViewModal
            title="View Lead Status Detail"
            open={viewModal}
...
export default memo(LeadStatusViewModal);
